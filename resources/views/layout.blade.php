                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                ...
                                <li><a href="#"><i class="fa fa-envelope"></i> lemada19@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="index.html"><img src="{{('public/frontend/images/logo-cake.png')}}" height="60px" alt="" /></a>
                        </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <p class="pull-right">Designed by <span><a target="_blank" href="#">Le Mada</a></span></p>
                </div>
            </div>
        </div>
